...
N  = 4; 	// Symmetry of polygon (starting from 3). 
...
//Compound Surface(2000)= {113, 116, 106, 110, 129, 133, 119, 124, 146, 150, 141, 136, 163, 167, 153, 158, 1001, 1003};
//Compound Surface(2000)= {*};

Mesh.RemeshAlgorithm=7;
Show "*";
